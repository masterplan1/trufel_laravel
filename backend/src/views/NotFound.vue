    ...
    >
      <div class="max-w-md">
        ...
        <router-link :to="{name: 'app.dashboard'}">
          <button
          class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-brand-rose active:bg-brand-rose hover:bg-brand-rose-dark"
        >
          На головну
        </button>
        </router-link>
