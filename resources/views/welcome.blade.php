<x-app-layout>
    <section class="max-w-6xl m-auto relative">
        <div class="pt-24 pb-32 text-center m-auto">
          ...
          <div class="flex font-marck items-center text-5xl text-red-300 w-[90%] mt-6 mb-4 justify-end">
            <span>tru</span>
          ...
          <div class="flex justify-between px-6 flex-col md:flex-row">
            <img class=" block" src="/img/wellcome-image.png" alt="">
            <p class="font-badscript text-xl pt-8 md:w-1/2 leading-10 text-left">
              Привіт! <br>
      
              На цій сторінці ми разом створимо ескіз твого тортика і втілимо твою солодку мрію
              в реальність. <br>
      
              Candybar, капкейки, чізкейки, тортики на твій день народження, для малечі, весільний...
              і просто до чаю! <br>
