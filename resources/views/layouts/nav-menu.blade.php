...
>
  ...
  <!-- Mobile Nav -->
  <nav :class="showMobileMenu ? 'left-0' : '-left-[220px]'" x-transition class="block md:hidden fixed top-0 bottom-0 bg-amber-50 w-[220px] h-full pt-20
  ...
  <div class="flex justify-between max-w-5xl m-auto">
    ...
    <nav x-data="{
      ...
      <ul @click.outside="closeAllMenus" class="grid grid-flow-col text-center">
        ...
        <li class="relative cursor-pointer">
          ...
          <ul x-show="openGalleryMenu" x-transition class="absolute left-1 bg-amber-50 text-left text-xl">
        ...
        <li class="relative cursor-pointer">
          ...
          <ul x-show="openOrderMenu" x-transition class="absolute left-1 bg-amber-50 text-left text-xl">
            @foreach ($types as $type)
    ...
    <div class="p-navbar-item">
      <a href="" class="flex">
        ...
        <small x-show="cartItemsCount > 0" x-text="cartItemsCount"></small>
      </a>
    </div>
  </div>
</div>