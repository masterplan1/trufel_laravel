...
<section class="font-kurale text-center">
  ...
  <div class="mt-10 sm:mt-20">
    <div class="flex justify-around gap-4 flex-wrap mb-8 text-center items-center">
      <div class="min-w-[142px] sm:min-w-[210px] px-2 sm:px-6 sm:py-2 shadow hover:bg-red-200 hover:text-white hover:border-red-200 cursor-pointer 
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1 mb-10">
      ...
      <div x-data="{ 
        ...
        <div class="relative">
          ...
          <img class="w-full h-[80vw] sm:h-[36vw] lg:h-[300px] rounded-md object-cover" src="{{ $filling->image }}" alt="">
        </div>
